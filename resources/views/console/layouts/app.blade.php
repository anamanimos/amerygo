...
<html lang="en">
	<!--begin::Head-->
	<head>
		<title>{{ $globalSettings['site_name'] ?? 'AMERYGO' }} - Konsol Admin</title>
		<meta charset="utf-8" />
		<meta name="description" content="Admin Dashboard" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta name="csrf-token" content="{{ csrf_token() }}">
		@if(!empty($globalSettings['site_favicon']))
		<link rel="shortcut icon" href="{{ asset($globalSettings['site_favicon']) }}" />
		@else
	...
	<body id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
		...
		<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
				@include('console.partials.header')
				<!--begin::Wrapper-->
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					@include('console.partials.sidebar')
					<!--begin::Main-->
