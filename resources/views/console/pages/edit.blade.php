    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">Edit: {{ $page->title }}</li>
            </ul>
        </div>
    </div>
</div>
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    <div id="kt_app_content_container" class="app-container container-fluid">
        <form action="{{ route('console.pages.update', $page->id) }}" method="POST" class="form d-flex flex-column flex-lg-row">
            @csrf
            @method('PUT')
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <input type="text" name="title" class="form-control mb-2" value="{{ old('title', $page->title) }}" required />
                        </div>
                        
                        <!-- Konten -->
                        <div class="mb-10">
                            <label class="form-label required">Konten / Isi Halaman</label>
                            <textarea id="kt_docs_ckeditor_classic" name="content" class="form-control" rows="15">{{ old('content', $page->content) }}</textarea>
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-10">
                            ...
                            <input type="text" class="form-control mb-2" name="meta_title" value="{{ old('meta_title', $page->meta_title) }}" />
                        </div>
                        <div>
                ...
                <div class="card card-flush py-4">
                    <div class="card-body pt-0">
                        <div class="form-check form-switch form-check-custom form-check-solid mt-4">
                            <input class="form-check-input" type="checkbox" value="1" id="is_active" name="is_active" {{ $page->is_active ? 'checked="checked"' : '' }} />
